...
public class Enemy : MonoBehaviour
{
	...
	void Start()
	{
		...
		// Randomize movement speed between a minimum and maximum value
		speed = UnityEngine.Random.Range(1.0f, 5.0f);  // Adjust range as needed

		// Randomize time to change direction
		timeToChange = UnityEngine.Random.Range(2.0f, 5.0f);  // Adjust range as needed
